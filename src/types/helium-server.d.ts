...
import type { updateTaskStatus as method_6_type } from '../server/tasks/index';
import type { createTask as method_7_type } from '../server/tasks/index';
import type { deleteTask as method_8_type } from '../server/tasks/index';
import type { editTask as method_9_type } from '../server/tasks/index';
...
export const editTask: import('helium/client').MethodStub<
    Parameters<typeof method_9_type['handler']>[0],
    Awaited<ReturnType<typeof method_9_type['handler']>>
>;
}
